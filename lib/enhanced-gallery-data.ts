/**
 * Galeri bölümü için gelişmiş örnek sanat eserleri ve görseller
...
export const enhancedArtworks: EnhancedArtwork[] = [
  {
    id: "1",
    ...
    tags: ["mimari", "porto", "cam tavan", "demir sütunlar"]
  },
  {
    id: "2",
    ...
    dimensions: "4000 x 3000 px",
    medium: "Dijital Fotoğraf",
    tags: ["modern", "minimalist", "doğal ışık", "galeri"]
  },
  {
    id: "3",
    ...
    dimensions: "4000 x 3000 px",
    medium: "Dijital Fotoğraf",
    tags: ["londra", "tate modern", "endüstriyel", "sergi alanı"]
  },
  {
    id: "4",
    ...
    dimensions: "4000 x 3000 px",
    medium: "Dijital Fotoğraf",
    tags: ["yeraltı", "aydınlatma", "atmosferik", "ışık oyunları"]
  },
  {
    id: "5",
    ...
    tags: ["dijital", "teknoloji", "renk", "form", "çağdaş"]
  },
  {
    id: "6",
    ...
    medium: "Akrilik Boya",
    tags: ["soyut", "renk teorisi", "akrilik", "modern", "duygu"]
  },
  {
    id: "7",
    ...
    dimensions: "4000 x 3000 px",
    medium: "Dijital Fotoğraf",
    tags: ["vitrin", "hediyelik", "el yapımı", "tasarım", "şık"]
  },
  {
    id: "8",
    ...
    tags: ["heykel", "çağdaş", "karışık medya", "3D", "sanat"]
  },
  {
    id: "9",
    ...
    dimensions: "4000 x 3000 px",
    medium: "Dijital Fotoğraf",
    tags: ["koridor", "mimari", "detay", "ışık", "gölge"]
  }
]

/**
 * Kategori filtreleri için gelişmiş veriler
 */
export const enhancedCategories = [
  { id: "all", name: "Tümü", count: enhancedArtworks.length },
  { id: "photography", name: "Fotoğraf", count: enhancedArtworks.filter(art => art.category === "photography").length },
  { id: "digital", name: "Dijital Sanat", count: enhancedArtworks.filter(art => art.category === "digital").length },
  { id: "painting", name: "Resim", count: enhancedArtworks.filter(art => art.category === "painting").length },
  { id: "sculpture", name: "Heykel", count: enhancedArtworks.filter(art => art.category === "sculpture").length }
]

/**
 * Etiket bazlı filtreleme için yardımcı fonksiyon
 */
export const getArtworksByTag = (tag: string) => {
...
/**
 * Popüler etiketleri getiren fonksiyon
 */
